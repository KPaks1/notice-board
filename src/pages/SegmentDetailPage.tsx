...
export default function SegmentDetailPage() {
  ...
  return (
    <div className="h-dvh bg-gray-950 flex flex-col max-w-lg mx-auto sm:rounded-2xl sm:overflow-hidden sm:shadow-2xl sm:shadow-black/60 sm:ring-1 sm:ring-white/10 md:max-w-none md:rounded-none md:shadow-none md:ring-0 overflow-hidden">
      <SegmentDetailPanel
        segment={segment}
        unit={unit}
        userLat={userLat}
